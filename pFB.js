...
const connection = mysql.createConnection({
  ...
  while (true) {
    ...
    if (programa === '999') {
      ...
      let nomePes = prompt ('Qual o nome da pessoa que deseja pesquisar? ')
      const query = `SELECT * FROM protocol WHERE nome LIKE '%${nomePes}%'`;
      ...
      connection.query(query, (err, rows) => {
        ...
        console.log("")
        rows.forEach((row) => {
        console.log(`Nome: ${row.nome}\nCodigo alfa númerico: ${row.alfa_pro}\nCódigo númerico: ${row.codigo}\nObservações: ${row.observacao}\n`)
        });
      });
    break; 
    } else if (programa === '3'){
      ...
      let tipo_alarme = prompt('0-Sem alarmes  1-Link_Loss  2-Board_Aport  3-Dying_Gasp  4-Overtrash ');
        switch(tipo_alarme){
          case '0':
            alfa_pro += 'Sa'
          break;
      ...
      let tipo_rote = prompt('0-Sem acesso  1-Comodato  2-Próprio ');
        switch(tipo_rote){
          case '0':
            alfa_pro += 'Sa'
          break;
      ...
      let tipo_sinal = prompt('0-Sem acesso  1-Ruim(-30dbm ^)  2-Preocupante(-27dbm)  3-Bom(-26dbm v) ');
        switch(tipo_sinal){
          case '0':
            alfa_pro += 'Sa'
          break;
      ...
      let tipo_login = prompt('0-Sem acesso  1-Admin  2-User  3-Multipro ');
        switch(tipo_login){
          case '0':
            alfa_pro += 'Sa'
          break;
      ...
      let tipo_login_senha = prompt ('0-Sem acesso  1-PPPoE  2-Fb@2+PPPoE  3-*123FBmudar ')
